 ...
 const navigate = useNavigate();
  ...
  const submitUserData = async(e) => {
    ...
    if (fname === "") {
      ...
      data.append("user_profile",image ? "" : imgdata) // Send empty string for new file, existing filename for no change
            ...
            <Form>
              <Row>
                ...
                <Form.Group className="mb-3 col-lg-6" controlId="formBasicEmail">
                  ...
                  <Select options={options} value={options.find(option => option.value === status)} onChange={setStatusValue} />
                </Form.Group>
                <Form.Group className="mb-3 col-lg-6" controlId="formBasicEmail">
